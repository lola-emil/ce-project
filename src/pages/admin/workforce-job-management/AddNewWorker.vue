...
<template>
    ...
    <div class="container mx-auto px-5 md:px-0">
        ...
        <div class="mt-5">
            <form @submit.prevent="worker.create()">
                <FieldGroup>
                    <Field>
                        <FieldLabel htmlFor="firstname">First Name</FieldLabel>
                        <Input id="firstname" v-model="worker.form.firstname" type="text" required />
                    </Field>

                    <Field>
                        <FieldLabel htmlFor="middlename">Middle Name</FieldLabel>
                        <Input id="middlename" v-model="worker.form.middlename" type="text" required />
                    </Field>

                    <Field>
                        <FieldLabel htmlFor="lastname">Last Name</FieldLabel>
                        <Input id="lastname" v-model="worker.form.lastname" type="text" required />
                    </Field>
                </FieldGroup>
                <br>
                <br>
