...
const columns: ColumnDef<TableData>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => h('form', {
            ...
            h(Input, {
                class: 'hover:bg-input/30 focus-visible:bg-background dark:hover:bg-input/30 dark:focus-visible:bg-input/30 h-8 w-16 border-transparent bg-transparent text-right shadow-none focus-visible:border dark:bg-transparent', defaultValue: row.original.target, id: `${row.original.id}-target`,
            }),
        ]),
    },
    {
        ...
        cell: ({ row }) => h('form', {
            ...
            h(Input, {
                class: 'hover:bg-input/30 focus-visible:bg-background dark:hover:bg-input/30 dark:focus-visible:bg-input/30 h-8 w-16 border-transparent bg-transparent text-right shadow-none focus-visible:border dark:bg-transparent', defaultValue: row.original.target, id: `${row.original.id}-limit`,
            }),
        ]),
    },
    {
