<template>
    ...
    <main class="container mx-auto grid grid-cols-4 gap-10">
        ...
        <div class="col-span-1 flex flex-col gap-5 min-h-[calc(100vh-4rem)] sticky top-0">
        ...
        <div class="col-span-3">
            ...
            <div v-if="profileStore.profile?.userType == 'client'" class="card mt-10">
                <div class="card-body p-0">
                    ...
                    <div class="flex flex-col gap-3">
                        <div v-if="postings.length == 0">
                            <p>
                                Not posted a single job yet.
                            </p>
                            <br>
                            <RouterLink to="/create-job-posting" class="link link-primary">Create New Job Post</RouterLink>
                        </div>
            ...
            <div v-if="auth.userType == 'worker'" class="mt-3">
                <div class=" grid grid-cols-3 gap-5">
                    <div v-for="value in range(0)" class="card border border-base-content/10">
            ...
            <div v-if="auth.userType == 'client'" class="mt-3">
                ...
                <div class="flex justify-center my-5">
                    <RouterLink to="/workers" v-if="range(0).length > 0" class="link link-primary text-center">View More</RouterLink>
                </div>
            </div>
        </div>
    </main>
...
import type { Notification, Posting } from '@/types';
